    ...
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          >
            ...
            <span className="ml-2 text-xl font-bold font-[Syne] tracking-wide text-gray-800 uppercase">
              YourHR
            </span>
          </a>
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm text-gray-800">
              YourHR is a job search service that aims to help job seekers find
              the ideal job roles based on their qualifications and preferences.
            </p>
        ...
        <div className="space-y-4 text-sm">
          <p className="text-base font-bold tracking-wide text-gray-900 mb-8">
            Contacts
          </p>
          <div className="flex">
          ...
          <div className="flex">
            <p className="mr-1 text-gray-800">Support:</p>
            <a
              href="mailto:support@yourhr.mail"
        ...
        <div className="container mx-auto flex flex-col justify-around text-center">
          <div className="flex flex-col justify-center lg:text-left">
            ...
            <h1 className="text-sm text-gray-800 mt-2">
          ...
          <div className="flex items-start justify-center sm:flex-col gap-2 mt-4">
            <button className="inline-flex w-48 items-center px-6 py-3 rounded-lg bg-teal-500 text-gray-50">
              ...
              <span className="flex flex-col items-start ml-4 leading-none font-[Syne]">
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-gray-600">
          © Copyright 2024 YourHr Inc. All rights reserved.
        </p>
